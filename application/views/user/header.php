...
<div class="header">
		...
		<div class="container">
			...
			<div class="logo">
				<h1 ><a href="<?php echo base_url();  ?>UserController/index"><b>T<br>H<br>E</b>Big Store<span>The Best Supermarket</span></a></h1>
			</div>
			<div class="head-t">
				<ul class="card">
					<li><a href="wishlist.html" ><i class="fa fa-heart" aria-hidden="true"></i>Wishlist</a></li>
					<li><a href="<?php echo base_url();  ?>UserController/login" ><i class="fa fa-user" aria-hidden="true"></i>Login</a></li>
					<li><a href="<?php echo base_url();  ?>UserController/signup" ><i class="fa fa-arrow-right" aria-hidden="true"></i>Register</a></li>
				...
				<div class="nav-top">
					...
					<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
						<ul class="nav navbar-nav ">
							<li class=" active"><a href="<?php echo base_url();  ?>UserController/index" class="hyper "><span>Home</span></a></li>	
